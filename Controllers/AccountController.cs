...
namespace ClinicaMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            bool showExternalLogin = string.Equals(RouteData.Values["action"]?.ToString(), "Administrador", StringComparison.OrdinalIgnoreCase);
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        // Asignar el rol de Administrador al usuario recién registrado
